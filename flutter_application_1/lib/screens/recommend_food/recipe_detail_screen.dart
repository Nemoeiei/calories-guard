...
class _RecipeDetailScreenState extends ConsumerState<RecipeDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_recipe == null) {
      return Scaffold(
        ...
        body: const Center(child: Text('ยังไม่มีสูตรอาหารนี้ในระบบ 😅',
              ...
              SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    ...
                    // ── Nutrition Card ──
                    _buildSection('📊 ข้อมูลโภชนาการ (ต่อจาน)', _buildNutritionCard(r)),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _green, borderRadius: BorderRadius.circular(99),
                    ),
                    child: Text('🍳 $category',
  ...
  Widget _timeChip(String icon, String val, String label, {bool isHighlight = false}) {
    return Container(
  ...
  Widget _buildMetaRow(Map<String, dynamic> r) {
    ...
    switch (diff.toLowerCase()) {
      case 'easy':   diffColor = const Color(0xFF628141); diffEmoji = '⚡'; break;
      case 'medium': diffColor = _orange; diffEmoji = '🔥'; break;
      default:       diffColor = Colors.red; diffEmoji = '💪'; break;
    }
  ...
  Widget _buildNutritionCard(Map<String, dynamic> r) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: const Color(0xFF2E7D52).withOpacity(0.3),
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: Column(children: [
                ...
                const Text('พลังงาน', style: TextStyle(fontSize: 12, color: Colors.white)),
              ]),
            ),
          ),
          const SizedBox(width: 8),
        ...
        return Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(name, style: const TextStyle(fontSize: 13,
              fontWeight: FontWeight.w600, color: Color(0xFF2E5040))),
          ]),
        );
      }).toList(),
    );
        ...
        return Container(
          ...
          child: Row(children: [
            ...
            Container(
              ...
              child: isOpt
                  ? const Text('✦', style: TextStyle(fontSize: 10, color: _orange))
                  : Text('$idx', style: const TextStyle(
            ...
            Expanded(child: Column(
              ...
              children: [
                Text(name, style: const TextStyle(fontSize: 14,
                  fontWeight: FontWeight.w600, color: Color(0xFF0D2118))),
                if (note.isNotEmpty)
            ...
            if (isOpt)
              Container(
                ...
                child: const Text('เสริม', style: TextStyle(fontSize: 10,
        ...
        return Row(
          ...
          children: [
            ...
            Column(children: [
              ...
              if (!isLast)
                Container(width: 2, height: 120, color: _greenMid),
            ]),
            const SizedBox(width: 12),
            // Right: content
            Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(inst, style: const TextStyle(
                        fontSize: 13, color: Color(0xFF2E5040), height: 1.6)),
                    ),
                    // Step image
                    if (img.isNotEmpty) ...[
                      const SizedBox(height: 8),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(child: Text(tip, style: const TextStyle(
                              fontSize: 12, color: Color(0xFF2E5040), height: 1.4))),
                          ],
                        ),
                      ),
                    ],
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(child: Text(text,
                    style: const TextStyle(fontSize: 13, color: Color(0xFF2E5040), height: 1.5))),
                ],
              ),
            ),
