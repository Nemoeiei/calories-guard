-- ==========================================
-- Database init script (schema ใหม่ใช้ public ไม่มี cleangoal)
-- วิธีรัน: psql -U user -d dbname -f init_database.sql
-- หลังรันแล้ว ถ้าใช้ backend กับ DB นี้ ให้แก้ database.py เป็น search_path=public
-- ==========================================

-- ==========================================
-- 🧹 0. CLEAN UP (ลบของเก่าออกเพื่อป้องกัน Error กรณีรันซ้ำ)
-- ==========================================
-- ลบตารางที่มี FK ก่อน
